                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark bold uppercase">Create New Category</span>
                                    </div>
                                    <div class="actions">
                                ...
                                <div class="portlet-body">
                                    <form class="form-horizontal" role="form" action="{{ route('admin.category_store') }}" method="POST">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            <label for="normal" class="col-md-2 control-label">Add Category</label>
                                            <div class="col-md-5">
                                                <input type="text" name="category_name" class="form-control" placeholder="Category" value="{{ @$category->category_name}}"> 
                                                
                                            </div>
                                            <input type="hidden" name="category_id" class="form-control" placeholder="category_id" value="{{ @$category->category_id}}">
                                        </div>

                                      

                                        <div class="form-group">
                                            <label for="silver" class="col-md-2 control-label">Description</label>
                                            <div class="col-md-5">
