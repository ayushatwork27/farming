...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            <div class="row login-wrap">
                ...
                <form class="login-form" action="{{route('user.login.submit')}}" method="post">
                    {{ csrf_field() }}
                    <h3 class="form-title font-green">User Login</h3>
                    <p class="sub-hd">Enter your username and password</p>
        ...
        <div class="copyright"> 2021 © Digital Kheti</div>
        <!--[if lt IE 9]>
