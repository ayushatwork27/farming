...
class UserDetailsController extends UserController
{
    ...
    public function save_user_details(Request $request){
    	...
    	$user_detail->passbook_image = $request->passbook_image;
    	$user_detail->passport_size_image = $request->passport_size_image;
    	$user_detail->signature_image = $request->signature_image;
    	$user_detail->aadhar_image = $request->aadhar_image;
    	$user_detail->save();
